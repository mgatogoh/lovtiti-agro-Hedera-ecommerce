    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                const redirect = searchParams.get('redirect') || `/dashboard/${selectedRole.toLowerCase()}`;
                            ...
                            <CardContent className="px-6 pb-8 space-y-6">
                                ...
                                <div className="space-y-4">
                                    <Label className="text-base font-medium flex items-center gap-2">
                                        ...
                                        Hedera Wallet Connection (Optional)
                                    </Label>
                                            ...
                                            <div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
                                                <div className="flex items-start gap-2">
                                                    ...
                                                    <div className="text-xs text-blue-700">
                                                        <p className="font-medium mb-1">Wallet connection is optional</p>
                                                        <p>
                                                            You can connect your wallet later from your dashboard. It's required for trading.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
